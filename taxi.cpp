suppose there is [[4,7],[-1,5],[3,6]] this is starting and ending point of car, output is 9 because we have to check the least numbers of cars on each point. it works like merge interval
